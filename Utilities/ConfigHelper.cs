...
namespace SkillFern.Utilities
{
    public class ConfigHelper
    {
        ...
        public static bool SkillPointsPurchaseable() { return skillPointsPurchaseable.Value; }
        ...
        private static ConfigEntry<float> discountPerPoint;
        public static float DiscountPerPoint() { return discountPerPoint.Value; }
        ...
        public static void Initialize(ConfigFile config)
        {
            ...
            skillCubeCost = config.Bind("Shop", "CostPerSkillPoint", 25, new ConfigDescription("How much skill point cubes cost per point (in thousands) (default 25)", new AcceptableValueRange<int>(1, 100)));
            ...
            levelsPerInterval = config.Bind("Shop - Advanced", "LevelsPerInterval", 2, new ConfigDescription("Number of levels before interval advances (default 2)", new AcceptableValueRange<int>(1, 100)));
            shopPointsCap = config.Bind("Shop - Advanced", "ShopPointsCap", 15, new ConfigDescription("Max number of points ever available in the shop (default 14)", new AcceptableValueRange<int>(1, 100)));
            discountPerPoint = config.Bind("Shop - Advanced", "DiscountPerPoint", 0.02f, new ConfigDescription("Discount applied to bundles per additional point in bundle. (default 0.02)", new AcceptableValueRange<float>(0, 1)));
